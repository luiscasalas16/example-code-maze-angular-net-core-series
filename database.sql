...
ALTER DATABASE [accountowner] SET  SINGLE_USER WITH ROLLBACK IMMEDIATE
GO
...
ALTER TABLE account  WITH CHECK ADD  CONSTRAINT fk_Account_Owner_idx FOREIGN KEY(OwnerId) REFERENCES owner (OwnerId)

ALTER TABLE account CHECK CONSTRAINT fk_Account_Owner_idx
